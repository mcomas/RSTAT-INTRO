...
* `ggraph` for graphs/networks <https://ggraph.data-imaginist.com/>
* `ggnetwork` for graphs/networks <https://briatte.github.io/ggnetwork/>
* `survminer` for survival curves <https://rpkgs.datanovia.com/survminer/index.html> (one year since last update)
